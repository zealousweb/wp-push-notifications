...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		...
		<a href="?page=web_push&tab=zealwpn-send-notification" class="nav-tab <?php if( $active_tab == 'zealwpn-send-notification' ){ echo 'nav-tab-active'; } ?>"><?php _e( 'Manual Notification', 'zeal-push-notification' ); ?></a>
...
You will get below details once you configured it correctly.', 'zeal-push-notification' ); ?></h4>
	...
	if( isset( $_GET["tab"] ) && $_GET["tab"] == "zealwpn-send-notification" ) {
		...
		<form method="POST" class="send_notification" autocomplete="off">
			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						<th><label for="notification_icon"><?php echo __( 'Notification Icon', 'zeal-push-notification' ); ?></label></th>
						<td>
							<?php
							echo '<a href="#" class="notificatio-img page-title-action">Upload image</a>
							<a href="#" class="notificatio-img-rmv page-title-action" style="display:none">Remove image</a>
							<input type="hidden" name="notification_icon" value="">';
							?>
						</td>
					</tr>
					<tr>
						<th><label for="notification_image"><?php echo __( 'Notification Image', 'zeal-push-notification' ); ?></label></th>
						<td>
							<?php
							echo '<a href="#" class="notificatio-img page-title-action">Upload image</a>
							<a href="#" class="notificatio-img-rmv page-title-action" style="display:none">Remove image</a>
		...
		<form method="POST" class="set_configuration" autocomplete="off">
			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						<th scope="row"><label for="wpn_post_message"><?php echo __('Notification Message', 'zeal-push-notification' ) ?></label></th>
						<td>
							<input name="wpn_post_message" class="" id="wpn_post_message" type="text" value="<?php echo get_option('wpn_post_message') ? get_option('wpn_post_message') : '{post_excerpt}'; ?>" size="100" aria-required="true">
							<div class="tooltip wpn_placeholders"><?php echo __( 'Placeholders', 'zeal-push-notification' ) ?><span class="tooltip_info"><p>{post_excerpt}</p></span></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input class="wpn_post_icon upload-field" name="wpn_post_icon" id="wpn_post_icon" placeholder="" type="text" value="<?php echo get_option('wpn_post_icon'); ?>" size="100" style="">
							<a href="#" class="post-notificatio-img page-title-action"><?php echo __('Upload image', 'zeal-push-notification' ) ?></a>
							<div class="tooltip wpn_placeholders"><?php echo __( 'Placeholders', 'zeal-push-notification' ) ?><span class="tooltip_info"><p>{featured_image}</p></span></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input class="wpn_post_image upload-field" name="wpn_post_image" id="wpn_post_image" placeholder="" type="text" value="<?php echo get_option('wpn_post_image'); ?>" size="100" style="">
							<a href="#" class="post-notificatio-img page-title-action"><?php echo __('Upload image', 'zeal-push-notification' ) ?></a>
							<div class="tooltip wpn_placeholders"><?php echo __( 'Placeholders', 'zeal-push-notification' ) ?><span class="tooltip_info"><p>{featured_image}</p></span></div>
						</td>
					</tr>
